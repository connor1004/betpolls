  ...
  <div style="background-color:#000000; color: #ffffff; margin: 0; padding: 0;">
    <div style="min-width: 280px; max-width: 640px; margin-left: auto; margin-right: auto; padding: 0 20px;">
      ...
      <div style="background-color: #ffffff; color: #000000; margin: 0; padding:1px 20px;">
        <p style="display: block; color: #000000">Hola, <strong><?php echo $user->firstname; ?></strong>,</p>
        <p style="display: block; color: #000000">Parece que olvidaste tu contraseña. Si esto es cierto, haga clic aquí para restablecer su contraseña.</p>
      ...
      <div style="padding: 20px 0; margin: 0;">
        <span style="color: #ffffff;">&copy;2019 Derechos Reservados</span>
      </div>
    </div>
  </div>
</body>
