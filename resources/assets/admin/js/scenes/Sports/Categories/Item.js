...
import {
  ...
  InlineError, TextField, TextStyle,
  ...
  renderEditMode() {
    ...
    return (
      <Formik
        ref={this.formikRef}
        initialValues={{
          home_team_first: data.home_team_first || 0,
          between_players: data.between_players || 0,
          name: data.name || '',
                ...
                <FormLayout>
                  ...
                  <FormLayout.Group>
                    <Checkbox
                      ...
                      checked={values.home_team_first === 1}
                      onChange={(value) => {
                        setFieldValue('home_team_first', value === true ? 1 : 0);
                      }}
                    />
                    <Checkbox
                      label="Between Players"
                      checked={values.between_players === 1}
                      onChange={(value) => {
                        setFieldValue('between_players', value === true ? 1 : 0);
                      }}
                    />
                  </FormLayout.Group>
                  <FormLayout.Group>
