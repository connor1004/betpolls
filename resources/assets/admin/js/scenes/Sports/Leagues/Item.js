...
import {
  Card, Stack, Select,
  Form, FormLayout,
  InlineError, TextStyle, TextField, Button, ButtonGroup,
  ResourceList, SkeletonBodyText, Thumbnail, Checkbox, Icon
  ...
  renderEditMode() {
    ...
    return (
      <Formik
        ...
        initialValues={{
          logo: data.logo || '',
          sport_area_id: `${data.sport_area_id}` || '',
          name: data.name || '',
          ...
          hide_standings: data.hide_standings ? 1 : 0
        }}
        validationSchema={
          Yup.object().shape({
        ...
        <ResourceList.Item>
          {
            showDeleteConfirm ? (
              ...
              <Stack>
                ...
                <Stack.Item fill>
                  <div style={{ width: '300px' }}>{data.name}</div>
                </Stack.Item>
                <Stack.Item fill>
                  <div style={{ width: '300px' }}>{data.name_es}</div>
                </Stack.Item>
                <Stack.Item>
                  <div style={{ width: '100px' }}>
                    {data.sport_area ? data.sport_area.name : ''}
                  </div>
                </Stack.Item>
                <Stack.Item>
                  <div style={{ width: '120px' }}>
                    {data.hide_standings ? <Icon source='checkmark' /> : ''}
                  </div>
                </Stack.Item>
                <Stack.Item>
